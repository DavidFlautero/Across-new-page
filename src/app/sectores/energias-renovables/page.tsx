...
const copy = {
  es: {
    ...
    ctaEyebrow: "Planificación logística especializada",
    ctaTitle: "Planifique su próxima operación renovable con un equipo experto.",
    ctaText:
      "Comparta el tipo de componente, dimensiones, origen, destino y condiciones de obra. Nuestro equipo analiza la viabilidad operativa, permisos, rutas y manipulación para construir una propuesta segura, trazable y eficiente.",
  ...
  en: {
    ...
    ctaEyebrow: "Specialized logistics planning",
    ctaTitle: "Plan your next renewable energy operation with an expert team.",
    ctaText:
      "Share the component type, dimensions, origin, destination and site conditions. Our team analyzes operational feasibility, permits, routes and handling requirements to build a safe, traceable and efficient proposal.",
