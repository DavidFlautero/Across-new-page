...
import styles from "./FarmaceuticoSanitario.module.css";
  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        ...
        <section className={`${styles.overview} ${styles.overviewMobileBg}`} data-after-cert-overview="true" style={{ "--sector-overview-bg": "url('/images/sectores/herofarmaceutico2.png')" } as CSSProperties}>
