...
import styles from "./AlimentacionBebidas.module.css";
  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        <section className={`${styles.hero} acrossPageHero`} data-sector-hero="true" data-standard-service-hero="true" data-sector-name="alimentacion-bebidas">
          <Image
        ...
        <section className={`${styles.overview} ${styles.overviewMobileBg}`} data-after-cert-overview="true" style={{ "--sector-overview-bg": "url('/images/sectores/alimentosybebidas.png')" } as CSSProperties}>
        ...
        <section className={styles.cleanServices} data-mobile-hide-after-cert="true">
          ...
          <div className={styles.serviceGrid}>
            {t.services.map(([title, text]: string[], index: number) => {
              const icons: IconName[] = ["package", "shield", "truck", "tracking", "door", "document"];
