...
import styles from "./Automocion.module.css";
  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        <section className={`${styles.hero} acrossPageHero`} data-sector-hero="true" data-standard-service-hero="true" data-sector-name="automocion">
          <Image
        ...
        <section className={`${styles.overview} ${styles.overviewMobileBg}`} data-after-cert-overview="true" style={{ "--sector-overview-bg": "url('/images/sectores/automocion2.png')" } as CSSProperties}>
