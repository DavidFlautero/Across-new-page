...
const copy = {
  "es": {
    "heroEyebrow": "Sector químico",
    "heroTitle": "Logística química para cargas que exigen control, seguridad y cumplimiento.",
    ...
    "overviewEyebrow": "Logística química especializada",
    "overviewTitle": "Control operativo para productos que requieren precisión y responsabilidad.",
    "overviewText": "El sector químico exige planificación, cumplimiento documental, manipulación adecuada y visibilidad en cada etapa. Diseñamos operaciones para reducir riesgos, mantener continuidad y proteger la integridad de la carga.",
    "overviewButton": "Conocer más sobre química",
    "pillars": [
      [
        "Control documental",
    ...
    "services": [
      [
        ...
        "Coordinación aérea, marítima o terrestre según producto, urgencia y requisitos."
      ],
      [
        "Carga regulada",
        "Gestión logística para mercancías que requieren documentación y control específico."
      ],
      [
        "Productos sensibles",
        "Soluciones para cargas que exigen cuidado, trazabilidad y seguimiento."
      ],
      [
      ...
      [
        ...
        "Gestión de stock y preparación bajo criterios operativos controlados."
      ],
      [
        "Door to door",
  ...
  "en": {
    "heroEyebrow": "Chemical sector",
    "heroTitle": "Chemical logistics for cargo that requires control, safety and compliance.",
    ...
    "services": [
      [
        ...
        "Air, ocean or road coordination according to product, urgency and requirements."
      ],
      [
        "Regulated cargo",
        "Logistics management for goods requiring documentation and specific control."
      ],
      [
        "Sensitive products",
        "Solutions for cargo requiring care, traceability and tracking."
      ],
      [
        "Import and export",
      ...
      [
        ...
        "Stock management and preparation under controlled operational criteria."
      ],
      [
        "Door to door",
  ...
  "zh": {
    "heroEyebrow": "化工行业",
    "heroTitle": "为需要控制、安全和合规的货物提供化工物流。",
  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        <section className={`${styles.hero} acrossPageHero`} data-sector-hero="true" data-standard-service-hero="true" data-sector-name="quimico">
          <Image
        ...
        <section className={styles.trustBar}>
          {t.trust.map(([title, text]: string[], index: number) => {
            const icons: IconName[] = ["shield", "package", "document", "tracking", "globe", "truck"];
