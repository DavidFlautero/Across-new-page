  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        ...
        <section className={styles.services} style={{ "--mobile-bg": "url('/images/caduana.png')" } as CSSProperties}>
        ...
        <section className={styles.darkBand} data-aduanas-extra-cta="true">
