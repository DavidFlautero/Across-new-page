      ...
      >
        ...
        <section className={`${styles.processAccordionSection} aereoProcessPremium`}>
          ...
          <div className={styles.processAccordionActions}>
            ...
            <div>
              <Link href="/cotizacion?servicio=aduanas">
                {locale === "es" ? "Solicitar cotización de aduanas" : locale === "en" ? "Request air quote" : "申请空运报价"}
              </Link>

              <Link href="/contacto?servicio=aduanas">
        ...
        <section className={styles.faqSection} data-aduanas-faq-section="true">
          <div className={styles.faqHead}>
            ...
            <h2>
              {locale === "es"
                ? "Dudas frecuentes sobre gestión aduanera."
                : locale === "en"
                  ? "Dudas frecuentes sobre gestión aduanera."
                  : "Dudas frecuentes sobre gestión aduanera."}
            </h2>
            ...
            <p>
              {locale === "es"
                ? "Resolvemos las principales dudas antes de iniciar una operación aduanera: documentación, clasificación, permisos, inspecciones y liberación."
                : locale === "en"
                  ? "Resolvemos las principales dudas antes de iniciar una operación aduanera: documentación, clasificación, permisos, inspecciones y liberación."
                  : "Resolvemos las principales dudas antes de iniciar una operación aduanera: documentación, clasificación, permisos, inspecciones y liberación."}
            </p>
          ...
          <div className={styles.faqList}>
            {[
              [
                locale === "es" ? "¿Qué documentos necesito para una operación aduanera?" : locale === "en" ? "¿Qué documentos necesito para una operación aduanera?" : "¿Qué documentos necesito para una operación aduanera?",
                locale === "es"
                  ? "Generalmente factura comercial, packing list, documentos de transporte, datos del importador/exportador y requisitos específicos según mercancía."
                  : locale === "en"
                    ? "Generalmente factura comercial, packing list, documentos de transporte, datos del importador/exportador y requisitos específicos según mercancía."
                    : "Generalmente factura comercial, packing list, documentos de transporte, datos del importador/exportador y requisitos específicos según mercancía."
              ],
              [
                locale === "es" ? "¿Across coordina importación y exportación?" : locale === "en" ? "¿Across coordina importación y exportación?" : "¿Across coordina importación y exportación?",
                locale === "es"
                  ? "Sí. Coordinamos gestión documental y operativa para operaciones de importación, exportación y tránsito internacional."
                  : locale === "en"
                    ? "Sí. Coordinamos gestión documental y operativa para operaciones de importación, exportación y tránsito internacional."
                    : "Sí. Coordinamos gestión documental y operativa para operaciones de importación, exportación y tránsito internacional."
              ],
              [
                locale === "es" ? "¿Qué pasa si la mercancía requiere permisos?" : locale === "en" ? "¿Qué pasa si la mercancía requiere permisos?" : "¿Qué pasa si la mercancía requiere permisos?",
                locale === "es"
                  ? "Revisamos requisitos previos, documentación adicional, autorizaciones y coordinación operativa antes del despacho."
                  : locale === "en"
                    ? "Revisamos requisitos previos, documentación adicional, autorizaciones y coordinación operativa antes del despacho."
                    : "Revisamos requisitos previos, documentación adicional, autorizaciones y coordinación operativa antes del despacho."
              ],
              [
                locale === "es" ? "¿Pueden revisar la documentación antes del embarque?" : locale === "en" ? "¿Pueden revisar la documentación antes del embarque?" : "¿Pueden revisar la documentación antes del embarque?",
                locale === "es"
                  ? "Sí. Revisamos documentos para reducir errores, retrasos y observaciones durante el proceso aduanero."
                  : locale === "en"
                    ? "Sí. Revisamos documentos para reducir errores, retrasos y observaciones durante el proceso aduanero."
                    : "Sí. Revisamos documentos para reducir errores, retrasos y observaciones durante el proceso aduanero."
              ],
              [
                locale === "es" ? "¿Cómo se cotiza una gestión aduanera?" : locale === "en" ? "¿Cómo se cotiza una gestión aduanera?" : "¿Cómo se cotiza una gestión aduanera?",
                locale === "es"
                  ? "Depende del tipo de operación, mercancía, régimen, documentación, permisos, inspecciones y complejidad del despacho."
                  : locale === "en"
                    ? "Depende del tipo de operación, mercancía, régimen, documentación, permisos, inspecciones y complejidad del despacho."
                    : "Depende del tipo de operación, mercancía, régimen, documentación, permisos, inspecciones y complejidad del despacho."
              ],
              [
                locale === "es" ? "¿Se puede hacer seguimiento del proceso?" : locale === "en" ? "¿Se puede hacer seguimiento del proceso?" : "¿Se puede hacer seguimiento del proceso?",
                locale === "es"
                  ? "Sí. Damos visibilidad sobre hitos clave: revisión documental, presentación, inspección, liberación y cierre operativo."
                  : locale === "en"
                    ? "Sí. Damos visibilidad sobre hitos clave: revisión documental, presentación, inspección, liberación y cierre operativo."
                    : "Sí. Damos visibilidad sobre hitos clave: revisión documental, presentación, inspección, liberación y cierre operativo."
              ]
...
<RelatedServices current="aduanas" locale={locale} />
      ...
      <div className={styles.mobileStickyCta} aria-label="Acciones rápidas de aduanas">
        <Link href="/cotizacion?servicio=aduanas">
