  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        <section className={`${styles.hero} acrossPageHero`} data-service-hero="compact" data-standard-service-hero="true" data-service-name="aduanas">
          <Image
        ...
        <section className={styles.services} data-dark-overlay="services" data-mobile-hide-after-cert="true" style={{ "--mobile-bg": "url('/images/caduana.png')" } as CSSProperties}>
        ...
        <section className={styles.darkBand} data-dark-overlay="darkBand" data-mobile-hide-after-cert="true" data-aduanas-extra-cta="true">
        ...
        <section className={styles.finalCta} data-dark-overlay="finalCta" style={{ "--mobile-bg": "url('/images/aduanashero.png')" } as CSSProperties} data-aduanas-cta="true" data-across-final-cta="true">
          <div>
            <h2>{t.finalTitle}</h2>
            <p>{t.finalText}</p>
