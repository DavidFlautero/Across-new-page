  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        ...
        <section className={styles.services} data-mobile-hide-after-cert="true" style={{ "--mobile-bg": "url('/images/caduana.png')" } as CSSProperties}>
        ...
        <section className={styles.darkBand} data-mobile-hide-after-cert="true" data-aduanas-extra-cta="true">
