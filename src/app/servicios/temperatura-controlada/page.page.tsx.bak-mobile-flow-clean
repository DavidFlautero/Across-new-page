...
import styles from "./TemperaturaControlada.module.css";
  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        <section className={`${styles.hero} acrossPageHero`} data-service-hero="compact" data-standard-service-hero="true" data-service-name="temperatura">
          <Image
        ...
        <section className={styles.services} style={{ "--mobile-bg": "url('/images/controltemp.png')" } as CSSProperties}>
        ...
        <section className={styles.darkBand} data-temp-extra-cta="true">
