  ...
  return (
    <div className="page-shell">
      ...
      >
        ...
        <section className={styles.services} data-mobile-hide-after-cert="true" style={{ "--mobile-bg": "url('/images/almacenHero.png')" } as CSSProperties} data-almacen-services-bg="true">
        ...
        <section className={styles.darkBand} data-mobile-hide-after-cert="true" data-almacen-darkband-bg="true">
