  ...
  return (
    <div className="page-shell">
      ...
      <main className={styles.page}>
        ...
        <section className={styles.services} data-dark-overlay="services" data-mobile-hide-after-cert="true" style={{ "--mobile-bg": "url('/images/almacen.png')" } as CSSProperties}>
        ...
        <section className={styles.darkBand} data-dark-overlay="darkBand" data-mobile-hide-after-cert="true" data-almacen-extra-cta="true">
        ...
        <section className={styles.finalCta} data-dark-overlay="finalCta" style={{ "--mobile-bg": "url('/images/almacenHero.png')" } as CSSProperties} data-almacen-cta="true" data-across-final-cta="true">
          <div>
            <h2>{t.finalTitle}</h2>
            <p>{t.finalText}</p>
