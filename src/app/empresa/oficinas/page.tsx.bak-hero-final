...
const copy = {
  es: {
    ...
    title: "Siempre cerca de su operación.",
    description:
      "En cualquier destino, en cada mercado y en cada etapa logística, Across Logistics está más cerca de lo que piensa.",
