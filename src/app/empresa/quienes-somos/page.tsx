...
const copy = {
  es: {
    ...
    blockTitle:
      "Logística internacional con visión operativa y compromiso de largo plazo.",
    blockText:
  ...
  en: {
    eyebrow: "ABOUT US",
    title: "Logistics with real control.",
    description:
    ...
    blockEyebrow: "ACROSS LOGISTICS",
    blockTitle:
      "International logistics with operational vision and long-term commitment.",
    blockText:
...
export default function QuienesSomosPage() {
  ...
  const heroTrust: readonly (readonly [string, string])[] = ({
    ...
    en: [
      ...
      ["Expert team", "Specialized support"],
    ],
    zh: [
      ["控制", "运营跟踪"],
      ["全球网络", "国际覆盖"],
    ...
    <div className={empresaHeroStyles.page}>
      ...
      >
        <Image
          ...
          alt="Across Logistics - Quiénes somos"
          fill
          priority
      ...
      <main className={styles.content}>
        ...
        <section className={styles.servicesPanel} data-quienes-services="true">
          <div className={styles.servicesCopy}>
            ...
            <div className={styles.accordion}>
              {t.services.map(([title, description]: readonly [string, string]) => (
                <details key={title} className={styles.serviceItem} open>
                  <summary>
                    <h3>{title}</h3>
                    <span>+</span>
                  </summary>
        ...
        <section
          ...
          data-team-expanded={showFullTeam ? "true" : "false"}
        >
          ...
          <button
            type="button"
            className={styles.teamMobileToggle}
            onClick={() => setShowFullTeam((value) => !value)}
          >
            {showFullTeam
              ? locale === "en"
                ? "Show less"
        ...
        <section
          ...
          style={
            {
              "--contact-bg": "url('/images/operador/contactcenter.png')",
            } as CSSProperties
          }
        >
          <div>
