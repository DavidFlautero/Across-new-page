...
const copy = {
  es: {
    eyebrow: "Servicios",
    title: "Soluciones logísticas para operaciones que exigen precisión.",
    description:
    ...
    services: [
      {
        ...
        text: "Soluciones aéreas para cargas urgentes, sensibles y de alto valor.",
        href: "/servicios/transporte-aereo",
        image: "/images/cargaaerea.png",
      },
      {
        eyebrow: "OCEAN FREIGHT",
        title: "Transporte Marítimo",
        text: "Operaciones marítimas internacionales para carga FCL, LCL y proyectos globales.",
      ...
      },
      {
        ...
        text: "Manejo especializado para mercancías sobredimensionadas y operaciones complejas.",
        href: "/servicios/cargas-especiales",
        image: "/images/logisticahome.png",
      },
      {
        eyebrow: "COLD CHAIN",
        title: "Temperatura Controlada",
        text: "Cadena de frío para productos farmacéuticos, perecederos y mercancías sensibles.",
        href: "/servicios/temperatura-controlada",
        image: "/images/temperaturacontrolada.png",
      },
      {
        eyebrow: "WAREHOUSE",
        title: "Almacén y Distribución",
        text: "Infraestructura flexible para almacenamiento, inventario y distribución.",
      ...
      },
      {
        ...
        text: "Gestión documental, fiscal, tributaria y coordinación con autoridades.",
      ...
      },
      {
        eyebrow: "COMMERCE",
        title: "e-Commerce",
        text: "Fulfillment, preparación de pedidos, integración digital y distribución.",
