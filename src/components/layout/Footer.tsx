...
const copy = {
  es: {
    ...
    servicesLinks: [
      ...
      ["/servicios/transporte-terrestre", "Transporte Terrestre"],
    ],
    companyLinks: [
  ...
  en: {
    ...
    servicesLinks: [
      ...
      ["/servicios/transporte-terrestre", "Road Freight"],
    ],
    companyLinks: [
  ...
  zh: {
    ...
    servicesLinks: [
      ...
      ["/servicios/transporte-terrestre", "陆运"],
    ],
    companyLinks: [
...
// Hook para activar acordeón en tablet/móvil (≤1100px)
...
export default function Footer() {
  ...
  const isOpen = (section: keyof typeof openSections) => {
    if (!isCompactFooter) return true;
